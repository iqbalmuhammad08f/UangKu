<header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 z-10">
    <button class="md:hidden text-gray-600" onclick="toggleSidebar('mobileSidebar')" aria-controls="mobileSidebar"
        aria-expanded="false">
    ...
    <div class="flex items-center gap-4">
        ...
        <a href="{{ route('profile.index') }}"
            class="flex items-center gap-2 cursor-pointer border-l pl-4 border-gray-200 hover:opacity-80 transition">
            <div
