...
<div id="editTransactionModal" class="fixed inset-0 z-50 hidden items-center justify-center">
    <div class="absolute inset-0 bg-opacity-50 backdrop-blur-sm transition-opacity flex items-center justify-center"
        onclick="toggleModal('editTransactionModal')"></div>
    ...
    <div class="relative flex min-h-full items-center justify-center p-4">
        <div
            ...
            <form id="form-editTransactionModal" action="#" method="POST" class="p-6 space-y-4">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-2 gap-2 p-1 bg-gray-100 rounded-lg mb-4">
                    <label class="cursor-pointer">
                        <input type="radio" name="type" value="expense" class="peer sr-only"
                            onchange="filterCategoriesForEdit('expense')">
                        <div
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="type" value="income" class="peer sr-only"
                            onchange="filterCategoriesForEdit('income')">
                        <div
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="category_id" id="edit_category_select"
                    ...
                    <div>
                        ...
                        <select name="wallet_id" id="edit_wallet_select"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm bg-white"
                            required>
...
<script>
    function filterCategoriesForEdit(type) {
