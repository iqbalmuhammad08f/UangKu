...
@section('content.layout')
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6 flex justify-between">
        <form class="flex justify-between gap-4">
            ...
            <select
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm text-gray-600 bg-white">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-full bg-orange-100 text-orange-500 flex items-center justify-center shrink-0">
                        ...
                        <td class="p-4">
                            <span
                                class="px-2.5 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-600 border border-gray-200">
                                Tunai
                            </span>
                        </td>
                        ...
                        <td class="p-4 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <button class="text-gray-400 hover:text-blue-600 transition"><i
                                        class="fa-solid fa-pen-to-square"></i></button>
                                <button class="text-gray-400 hover:text-red-600 transition"><i
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4">
                            <span
                                class="px-2.5 py-1 rounded-full text-xs font-medium bg-blue-50 text-blue-600 border border-blue-100">
                                BCA
                            </span>
                        </td>
        ...
        <div class="px-4 py-3 border-t border-gray-200 flex items-center justify-between bg-gray-50">
            ...
            <div class="flex gap-1">
                <button
                    class="px-3 py-1 rounded border border-gray-300 bg-white text-gray-600 text-xs hover:bg-gray-50">Prev</button>
                <button
                    class="px-3 py-1 rounded border border-blue-500 bg-blue-50 text-blue-600 text-xs font-bold">1</button>
                <button
                    class="px-3 py-1 rounded border border-gray-300 bg-white text-gray-600 text-xs hover:bg-gray-50">2</button>
                <button
                    class="px-3 py-1 rounded border border-gray-300 bg-white text-gray-600 text-xs hover:bg-gray-50">Next</button>
            </div>
        </div>
    </div>
@endsection
