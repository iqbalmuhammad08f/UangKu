    ...
    <div class="pb-6">
        <div
            ...
            <div class="relative z-10 flex justify-between items-end">
                <div>
                    <p class="text-white text-sm font-medium mb-2">Total Saldo</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ($wallets as $wallet)
                <div
                    ...
                    <p class="text-2xl font-bold text-blue-600 mt-3">Rp {{ number_format($wallet->balance, 0, ',', '.') }}
                    </p>
            ...
            <div class="relative flex min-h-full items-center justify-center p-4">
                <div class="bg-white w-md rounded-2xl shadow-2xl p-6 animate-fade-in-up">
                    ...
                    <form action="{{ route('wallets.transfer') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 mb-1">Jumlah Transfer</label>
                            <div class="relative">
